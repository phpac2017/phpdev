				...
				<div class="col-sm-6 col-xs-12 text-right">
					<div class="row">
						<div class="col-md-12 text-right mob-icons">
							...
							<a href="#" class="login_register doctor_login_register">Login / Register</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="slideshow">
			<div class="carousel-inner" role="listbox">				 
				<div class="item active">
					<img src="images/banner/doctor_banner.jpg" alt="slide1">
						...
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
									...
									<a href="#" class="create_profile">Create your free profile</a>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			...
			<div class="col-md-5 col-sm-12 text-center">
				<div class="doctor_profile_img_right patient_across">
					<img src="images/banner/patient_across.png" alt="" />
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-md-5 col-sm-12 text-center">
				<div class="doctor_profile_img_right">
					<img src="images/banner/substancial_image.jpg" alt="" />
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-7 col-sm-12">
				<div class="doctor_profile_left">
					...
					<img src="images/download_gp - black.png" alt=""> <img src="images/download_app_store - black.png" alt="">
				</div>
			</div>
			<div class="col-md-5 col-sm-12 text-center">
				<div class="doctor_profile_img_right patient_across">
					<img src="images/banner/immage.jpg" alt="" />
				</div>
			</div>
		</div>
	</div>
