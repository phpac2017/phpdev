		...
		<div class="row">
			<div class="col-lg-offset-2 col-lg-8 col-md-offset-1 col-md-10 col-sm-offset-0 col-sm-12">
				<div class="login-register-tab">
					...
					<form id="otp_form" name="otp_form" data-toggle="validator" role="form">
					<div class="tab-content">
						<div class="tab-pane active" id="home1">
							<div class="form-group">
								...
								<input type="text" value=""  placeholder="Enter Verification Code (OTP)" class="form-control" id="otp" required>
							</div>
							<a href="#" class="resend-otp">Resend ?</a>
							<button class="btn btn-formsubmit" type="submit">Verify</button>
						</div>
						<div class="tab-pane" id="profile1">
							...
							<div class="form-group">
								...
								<input type="password" value="" class="form-control" id="pwd" name="pwd" required>
							</div>
