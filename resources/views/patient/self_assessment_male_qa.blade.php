		...
		<div id="page-content-wrapper">
			<aside class="right-sidebar">
					...
					<div class="row">
						<div class="col-md-4 col-sm-12">
							<ul class="breadcrumbs-left">
								<li>Home</li>
								<li><a href="{{ url('self_assessment') }}">Self Assesment</a></li>
							</ul>
						</div>
				...
				<div class="appointment_opendiv">
								...
								<div class="text-right"><a class="btn btn-formsubmit password-btn goback-button" href="#">Go Back</a></div>	
									...
									<div class="additional_info">
										...
										<div class="row" id="#complete">
											<div class="">
												...
												<div class="text-center appointment-but-div">
												<a class="btn btn-formsubmit password-btn" href = "{{ url('patient/schedule_appointment') }}">Get Appointment</a>
												</div>
											</div>				
										</div>
									</div>
