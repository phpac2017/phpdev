			...
			<div class="col-lg-offset-2 col-lg-8 col-md-offset-1 col-md-10 col-sm-offset-0 col-sm-12">
				<div class="login-register-tab">
					...
					<div class="tab-content">
						...
						<form data-toggle="validator" role="form" id="pat_reg_form">	
							<div class="form-group">
								 <label class="control-label" for="fname">Name</label>
                      <input class="form-control" data-error="Please Enter Name field." id="fname" placeholder=" Your Name"  type="text" required />
                      <div class="help-block with-errors"></div>
							...
							<div class="row">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<div class="form-group">
										<label class="control-label" for="mbbileno">Mobile Number <span class="mandatory">*</span></label>
										<input type="text" data-error="Please Enter Mobile Number" class="form-control" id="mobileno" placeholder="Mobile Number" required="">
										 <div class="help-block with-errors"></div>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<input type="email"  class="form-control" id="email" data-error="Please Enter Email Field" placeholder="Your Email ID" required="">
								 <div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" value="Medical Registration Number" class="form-control" id="pwd" required="">
							</div>
							...
							<button class="btn btn-primary" type="submit">Let's Get Started</button>
						</div>
						<div class="tab-pane login-user" id="profile1">
							...
							<div class="form-group">
								...
								<input type="text" value="" class="form-control" id="usr1" required="">
							</div>
							<div class="form-group">
								<label for="pwd">Password:</label>
								<input type="password" value="" class="form-control" id="pwd1" required="">
							</div>
							<div class="row">
