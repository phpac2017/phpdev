    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <aside class="leftsidebar">
				...
				<ul class="left-profile">
					...
					<li class="active"><a href="registration-documents.html"><span><img src="images/commitments-list.png" alt="" /></span>Registration & Documents</a></li>
        ...
        <div id="page-content-wrapper">
          <aside class="right-sidebar">
			...
			<form id="dr_reg_doc" name="dr_reg_doc" data-toggle="validator" role="form">
			<div class="edit-profile-photo login-register-tab">
				<h2>Registration & Documents</h2>
					...
					<div class="awards-recognitions">
						...
						<div class="add-award">
							<button class="add-schedule"><i class="fa fa-plus fa-lg" aria-hidden="true"></i> Add Registration</button>
						</div>
						<div class="row">
							<div class="col-lg-4 col-md-6">
								<div class="form-group">
									<label for="usr">Council Registration Number: <span class="mandatory">*</span></label>
									<input type="text" value="" placeholder="Enter Council Registration Number" class="form-control" id="cregno" name="cregno" required>
